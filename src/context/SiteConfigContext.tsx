...
export const mergeConfig = (data: unknown): SiteConfig => {
  ...
  return {
    ...
    socialSection: {
      ...defaultConfig.socialSection,
      ...(d.socialSection ?? {}),
      items: (d.socialSection as { items?: unknown[] } | undefined)?.items ?? defaultConfig.socialSection.items,
      displayName: (d.socialSection as { displayName?: string } | undefined)?.displayName ?? defaultConfig.socialSection.displayName,
