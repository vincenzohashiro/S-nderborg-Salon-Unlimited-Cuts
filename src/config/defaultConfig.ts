...
export const defaultConfig: SiteConfig = {
  ...
  reviews: [
    { id: "1", author: "Mikkel Hansen",      initials: "MH", rating: 5, text: "Fantastisk oplevelse! Wasim er utrolig dygtig og tog sig tid til at forstå præcis, hvad jeg ønskede. Kommer helt sikkert igen.",              date: "For 2 uger siden"    },
    { id: "2", author: "Ahmed Al-Rashidi",   initials: "AA", rating: 5, text: "Bedste barber i Sønderborg! Professionel service og et super hyggeligt sted. Klipningen sidder altid perfekt.",                              date: "For 1 måned siden"   },
    { id: "3", author: "Jonas Petersen",     initials: "JP", rating: 5, text: "Har været her flere gange og er aldrig blevet skuffet. Præcist arbejde og god atmosfære. Stærkt anbefalet!",                                  date: "For 3 uger siden"    },
    { id: "4", author: "Christoffer Larsen", initials: "CL", rating: 5, text: "Virkelig imponerende håndværk. Wasim ved præcis hvad han laver og resultatet er altid i top. 5 stjerner fortjent!",                          date: "For 2 måneder siden" },
    { id: "5", author: "Rasmus Nielsen",     initials: "RN", rating: 5, text: "Kom ind uden aftale og blev taget imod med et smil. Klipningen var perfekt og prisen fair. Super sted!",                                      date: "For 1 uge siden"     },
    { id: "6", author: "Omar Khalid",        initials: "OK", rating: 5, text: "Har gået her i over et år. Altid tilfreds med resultatet. Wasim er en rigtig dygtig barber og et godt menneske.",                            date: "For 3 måneder siden" },
  ],
  seo: {
